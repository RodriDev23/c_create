...
int create_file_compile(char *name_project) {
  char path[200];
...
int create_file_c(char *name_project) {
  char path[200];
  snprintf(path, sizeof(path), "%s/main.c", name_project);
